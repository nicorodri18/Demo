...
def manejar_error_autenticacion():
    print('Error de autenticación. Credenciales inválidas.')


def manejar_error_registro():
    print('Error: El usuario ya existe.')

if __name__ == '__main__':
   
    if autenticar_usuario('usuario1', 'contraseña123'):
        print('Autenticación exitosa')
    else:
        manejar_error_autenticacion()

   
    if registrar_usuario('usuario2', 'contraseña456'):
        print('Usuario registrado correctamente')
    else:
        manejar_error_registro()
